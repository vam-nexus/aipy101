const chapters = [
            // ------- Chapter 1 -------
            {
                title: "Preparation Guide for the AI Python Course",
                content: `
                    <div class="blog-post">
                        ...
                        <section class="post-section">
                         ...
                         <section class="post-section">
                            <h2>Getting Ready</h2>
                            <p>It is highly encouraged to complete the chapters in this guide before our Sunday crash course to help you prepare and have a smooth learning experience.</p>
                            <p>This is an intense course, but you only have to do it once in your lifetime to learn these foundational skills.</p>
                            <p>This guide should take about <strong>45 minutes</strong> to complete and it is best done on a <strong>laptop</strong> as opposed to a phone.</p>
                            <p>You can ask as many questions as you want in the Discord community for support.</p>
                            <div style="text-align: center;">
                                     <a href="https://discord.gg/R7eTE7b7" target="_blank" class="join-discord-button">Join Discord</a>
                                 </div>
                ...
                content: `
                    <div class="blog-post">
                        <section class="post-section">
                            ...
                            <p>Artificial Intelligence (AI) is changing the way we work and interact with technology. 
                            <p>Today, learning to code is no longer just for software engineers. People in many professions, such as journalism, marketing, business, and administration, find that even a small amount of programming knowledge can make them more effective and productive.</p>
                            <p>This course introduces Python, a simple and powerful programming language, and explores its role in AI.</p>
                        </section>

                        <section class="post-section">
                            <h2>How AI is Changing Coding</h2>
                            <p>In the past, learning to code required years of study and practice. </p>
                            <p>It involved memorizing syntax, understanding algorithms, and writing programs from scratch.</p>
                            <p>However, AI-powered tools like ChatGPT are making it easier to learn and write code. With AI as an assistant, beginners can get instant feedback, generate code snippets, and find errors quickly.</p>
                            <p>These tools lower the barriers to coding, making it more accessible to everyone.</p>
                        </section>

                        <section class="post-section">
                            <h2>Why Python for AI?</h2>
                            <p>Python is one of the most widely used programming languages, especially in AI and data science. It is known for its simple syntax, readability, and vast collection of libraries that support machine learning, automation, and data analysis. 
                            <p>Because of its ease of use and flexibility, Python is the best choice for those who want to get started with AI.</p>
                        </section>

                        <section class="post-section">
                            <h2>The Power of AI-Assisted Learning</h2>
                            <p>AI is transforming how people learn to code. Instead of relying only on textbooks and structured courses, learners can now use AI-powered coding assistants. These tools help beginners write better code, understand concepts faster, and solve problems more efficiently.</p>
                            <p>AI-assisted learning makes it possible for anyone to gain coding skills, even without a traditional computer science background.</p>
                        </section>

                        <section class="post-section">
                            <h2>The Benefits of Learning Python</h2>
                            <p>Knowing how to code, even at a basic level, can be a significant advantage. It allows people to automate repetitive tasks, analyze data, and build AI-powered applications.</p>
                            <p>Coding also develops problem-solving skills and logical thinking, which are valuable in any field.</p>
                            <p>Plus, many people find programming to be a fun and creative activity.</p>
                        </section>
                        ...
                        <section class="post-section">
                            <h2>What's Next?</h2>
                            <p>In the next chapter, we will explore the fundamentals of programming languages and how they allow us to communicate with computers. 
                            <p>By learning Python, you will gain the skills to work with AI and unlock new opportunities in your career and personal projects.</p>
                        </section>
                    </div>
                `
            },
                ...
                content: `
                    <div class="blog-post">
                        <section class="post-section">
                            ...
                            <p>Previously, if we were stuck with a programming task or unsure what to do next, we might have had to find an expert to ask. 
                            <p>This process could take time, finding someone available, explaining the issue, and waiting for a response. However, now, whenever we have a question, we can ask an AI chatbot and get an answer immediately.</p>
                            <p>For this course, we can use a chatbot like ChatGPT, Microsoft Copilot, Anthropic Claude, or Google Gemini that allows us to type our programming questions, also known as prompts, directly into it. </p>
                        ...
                        <section class="post-section">
                            ...
                            <p>If we want to learn more about what a piece of code does, we can enter:</p>
                            <pre><code class="language-python"><strong>"What does this code mean?"</strong></code></pre>
                        ...
                        <section class="post-section">
                            ...
                            <p>Executing this code tells the computer to print the message "Hello, World!" to the screen.</p>
...
Like a diamond in the sky.")
                        ...
                        <section class="post-section">
                            ...
                            <div style="text-align: center;">
                                <a href="https://discord.gg/R7eTE7b7" target="_blank" class="join-discord-button">Discord Link</a>
                            </div>
                        </section>
                ...
                content: `
                    <div class="blog-post">
                        ...
                        <section class="post-section">
                            ...
                            <p>To strengthen your coding skills, test your understanding by predicting what will happen before running the code. Ask yourself or (ChatGPT) questions like:</p>
                            <ul>
                            ...
                            <p style="background-color: #f0f8ff; padding: 10px; border-radius: 5px;">Try this out with the code block under the cell <strong>"What would happen if..." by asking ChatGPT</strong></p>
                            
                            <pre><code class="language-python">
# Try modifying this code to see what happens by asking ChatGPT
# Example 1: What happens if you remove a quotation mark?
print("Hello, World!")

# Example 2: What happens with incorrect parentheses? 
# You can ask ChatGPT  or/and run it on the <a href="https://colab.research.google.com/drive/1LEav6Yxcx5j_cb48KzfJQ1QF1zQESTKb?usp=sharing" target="_blank">Google Colab</a>
result = (5 + 3) * 2
print(result)

# Example 3: What happens if you change the indentation? 
# you can ask ChatGPT or/and run it on the <a href="https://colab.research.google.com/drive/1LEav6Yxcx5j_cb48KzfJQ1QF1zQESTKb?usp=sharing" target="_blank">Google Colab</a>
if True:
    print("This is indented correctly")
    print("This is also correct")
# Try removing the indentation on one of these lines

# Example 4: What happens with a missing colon? 
# you can ask ChatGPT  or/and run it on the <a href="https://colab.research.google.com/drive/1LEav6Yxcx5j_cb48KzfJQ1QF1zQESTKb?usp=sharing" target="_blank">Google Colab</a>
for i in range(3):
    print(i)
</code></pre>
                        ...
                        <section class="post-section">
                            ...
                            <p>Think of an AI chatbot as your coding companion. It is patient, knowledgeable, and always available to assist you. 
                            <p>Whenever you encounter difficulties, feel free to ask the chatbot questions such as:</p>
                            <ul>
                                <li>Copy the code block under <strong>"# What is this mystery algorithm?"</strong> and paste it into ChatGPT and ask <pre><code class="language-python">"What does this code do?"</code></pre>
                                <pre><code class="language-python">
...
print(mystery_function(10))
                                ...
                                <li>Copy the code block under <strong>"# Why does the Geometric Series below output 2.0?"</strong> and paste it into ChatGPT and ask <pre><code class="language-python">"Why does this function work this way?"</code></pre>
                                <pre><code class="language-python">
# Why does the Geometric Series below output 2.0?
def geometric_series(r, n):
    """Calculate the sum of a geometric series: 1 + r + r^2 + ... + r^(n-1)"""
    if abs(r) < 1:
        return (1 - r**n) / (1 - r)
    else:
        return sum(r**i for i in range(n))

# This outputs 2.0 - but why?
print(geometric_series(0.5, 100))
</code></pre>
                                </li>
                                <li>Copy the code block under <strong>"# Code below doesn't work :("</strong> and paste it into ChatGPT and ask <pre><code class="language-python">"How can I fix this error?"</code></pre>
                                <pre><code class="language-python">
...
print(calculate_average(my_list))
                        ...
                        <section class="post-section">
                            ...
                            <p>Errors in code are completely normal, especially when learning a new programming language. 
                            <p>There almost never has been a time when I and probably anyone who has written code without making an error in the first attempt. 
                            <p>You can think of errors as guideposts to help you learn. Just as with learning a new spoken language, you may not get everything right the first time, and that is okay! Instead of getting frustrated, use errors as learning opportunities.</p>
                            <ul>
                        ...
                        <section class="post-section">
                            ...
                            <div class="practice-box" style="background: #F3F4F6; padding: 1rem; border-radius: 0.5rem; margin: 1rem 0;">
                                ...
                                <p>Once you are done, take a screenshot showing that you completed them and share it on <a href="https://discord.gg/R7eTE7b7" target="_blank">Discord's #share-your-work</a> channel</p>
                            </div>
                    ...
                    <div class="blog-post">
                        ...
                        <section class="post-section-no-counter">
                         <h2>In Conclusion:</h2>
                            ...
                            <p>We look forward to seeing you on Sunday for the crash course. 
                        </section>
                    </div>
                `
            }
