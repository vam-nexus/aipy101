"""
Concept: Flask Todo List

This example demonstrates user-specific data management with Flask.
Students will learn about user sessions, data persistence, and CRUD operations.
"""

# Task 12 - Flask Todo List (Example File)
# This file demonstrates a todo list system with user authentication
